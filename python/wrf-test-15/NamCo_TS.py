...
#%%
    ...
    ax.plot(prec1_NamCo.Time+pd.Timedelta('6H'), prec1_NamCo, lw=1.4, c='r', marker='o', mfc=None, markersize=3.5, label='Ctrl')
    ax.plot(prec2_NamCo.Time+pd.Timedelta('6H'), prec2_NamCo, lw=1.4, c='g', marker='o', mfc=None, markersize=3.5, label='nolake')
