...
if __name__ == '__main__':
    ...
    geo_path = f'/home/zzhzhao/Model/tests/test-{test_number}/WPS/geo_em.d02.nc'
...
#%%
    ...
    fig.savefig(f'/home/zzhzhao/code/python/wrf-test-{test_number}/fig/wind.jpg', dpi=300)
